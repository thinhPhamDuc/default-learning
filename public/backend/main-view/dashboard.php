...
<div id="wrapper">
    ...
    <?php include '../../../public/backend/layouts/sidebar.php' ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <?php include '../../../public/backend/layouts/topbar.php' ?>

            <?php include '../../../public/backend/layouts/content.php' ?>

        </div>
        <!-- End of Main Content -->

       <?php include '../../../public/backend/layouts/footer.php' ?>
...
<?php include '../../../public/backend/layouts/modal-scroll.php' ?>
